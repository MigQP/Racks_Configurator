...
public class BuildSystem : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.R))//rotar
        {
        ...
        if (Input.GetMouseButtonDown(0) && isBuilding)//construir
        {
    ...
    private void StopBuild ()//Build it
    {
        previewScript.Place();
        previewGameObject = null;
        previewScript = null;
    ...
    private void DoBuildRay ()
    {
        ...
        if (Physics.Raycast(ray, out hit, 100f, layer))
        {
            ...
            //previewGameObject.transform.position = hit.point; *USAR ESTA PARA MODELOS IMPORTADOS*
        }
    }
}
